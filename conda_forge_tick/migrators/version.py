...
class Version(Migrator):
    ...
    def pr_body(self, feedstock_ctx: FeedstockContext) -> str:
        ...
        # in the PR body.
        about = feedstock_ctx.attrs.get("about")
        ...
        body = body.format(
            ...
            "- [ ] Dependencies have been updated if changed: see [upstream]({upstream_url})\n"
            "- [ ] Tests have passed \n"
            "- [ ] Updated license if changed and `license_file` is packaged \n"
            "\n"
            "Note that the bot will stop issuing PRs if more than {max_num_prs} Version bump PRs "
